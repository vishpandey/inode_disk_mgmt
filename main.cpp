...
#define NO_OF_DATA_BLOCKS (DATA_SIZE / BLOCK_SIZE)
#define NO_OF_INODES (0.6 * NO_OF_DATA_BLOCKS)
#define NO_OF_SB_BLOCKS (NO_OF_DATA_BLOCKS + NO_OF_INODES) / BLOCK_SIZE
#define NO_OF_TOTAL_BLOCKS (NO_OF_DATA_BLOCKS + NO_OF_INODES + NO_OF_SB_BLOCKS)
...
long long int total_disk_size = 1 * sizeof(struct SuperBlock) + 
								...
								NO_OF_DATA_BLOCKS * DATA_BLOCK_SIZE;
...
void create_disk(string diskname, string diskpath) {
	FILE *diskDescriptor = fopen(diskpath, "wb"); 
